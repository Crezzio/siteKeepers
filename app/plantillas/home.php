...
<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
    <header class="masthead mb-auto">
        <div class="inner">
            <a class="masthead-brand mr-2" href="/index.php?ctl=home">
                <img src="web/img/logo.png" alt="Logo" style="width:40px;">
            </a>
            <h3 class="masthead-brand">Site Keepers</h3>
            <nav class="nav nav-masthead justify-content-center">
                <a class="nav-link active" href="/index.php?ctl=home">Home</a>
                <a class="nav-link" href="/index.php?ctl=inicio">Principal</a>
    ...
    <main role="main" class="inner cover">
        ...
        <p class="lead">Keeping your site for bright future.</p>
        <p class="lead">
            <a href="/index.php?ctl=inicio" class="btn btn-lg btn-secondary">Entra en el sitio</a>
        </p>
    </main>
